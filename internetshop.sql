...
(
    id bigint NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    user_id bigint NOT NULL,
    paying_status boolean NOT NULL DEFAULT false,
...
(
    ...
    CONSTRAINT orders_details_pkey PRIMARY KEY (order_id, product_id),
    CONSTRAINT orders_details_order_id_fkey FOREIGN KEY (order_id)
        REFERENCES public.orders (id) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID,
    CONSTRAINT orders_details_product_id_fkey FOREIGN KEY (product_id)
